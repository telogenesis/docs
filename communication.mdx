...
Every employee gets their own email address, like jeff@agent.telogenesis.ai. Anyone can email them directly, just like they would email any other person.
...
- Use subaddressing (like jeff+project@agent.telogenesis.ai)
...
When you create an employee, they automatically get their own email address at agent.telogenesis.ai. Share this address with anyone who needs to communicate with them - clients, colleagues, or anyone else.
...
Your employees are automatically assigned phone numbers. You can view each employee's number in the Employees tab at dashboard.telogenesis.ai/employees.
