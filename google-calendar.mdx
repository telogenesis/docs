...
Every Telogenesis employee has an email address (for example, `jeff@agent.telogenesis.ai`). You can share your Google calendars with your employees through the [Google Calendar](https://calendar.google.com) web app, just like you would with a human employee.
...
# Verify everything from the dashboard

1. Head to the [Calendars](https://dashboard.telogenesis.ai/calendar) section in the dashboard.
2. Pick the same employee in the **Employee Shared Calendars** section.
3. Confirm the shared calendar appears with the permission level you expect. It can take up to a minute for Google to synchronize.

![Calendar Tab](assets/calendars/google_calendars/calendar_tab.png)