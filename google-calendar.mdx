...
description: Share Google Calendars with your Kuren employees.
---

# Sharing

Every Kuren employee has an email address (for example, `jeff@agent.kuren.ai`). You can share your Google calendars with your employees through the [Google Calendar](https://calendar.google.com) web app, just like you would with a human employee. You can browse shared calendars in the [Calendars](https://app.kuren.ai/calendar) section in the dashboard.
...
- The employee must have the `google_calendar` tool category enabled (check the **Tool Categories** section, in the [Employee Tab](https://app.kuren.ai/employees)).